...
export function InvoiceOperationsButtons({ invoice }: { invoice: { id: string; status: string; amount: number; allowanceTotal: number; invoiceDate: Date | null } }) {
	...
	return (
		<div className="flex flex-wrap items-center gap-2">
			{invoice.status === "ISSUED" && (
				...
				) : <Button size="sm" variant="outline" onClick={() => setConfirm("void")}>作廢發票</Button>
			)}
			{confirm === "allowance" ? (
