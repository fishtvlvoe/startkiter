---
name: "source-command-spectra-ask"
description: "Migrated source command `spectra-ask`"
---

# source-command-spectra-ask

Use this skill when the user asks to run the migrated source command `spectra-ask`.
