---
name: "source-command-spectra-debug"
description: "Migrated source command `spectra-debug`"
---

# source-command-spectra-debug

Use this skill when the user asks to run the migrated source command `spectra-debug`.
