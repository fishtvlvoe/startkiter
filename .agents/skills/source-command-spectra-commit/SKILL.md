---
name: "source-command-spectra-commit"
description: "Migrated source command `spectra-commit`"
---

# source-command-spectra-commit

Use this skill when the user asks to run the migrated source command `spectra-commit`.
