---
name: "source-command-spectra-discuss"
description: "Migrated source command `spectra-discuss`"
---

# source-command-spectra-discuss

Use this skill when the user asks to run the migrated source command `spectra-discuss`.
