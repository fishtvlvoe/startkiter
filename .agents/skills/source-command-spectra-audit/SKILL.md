---
name: "source-command-spectra-audit"
description: "Migrated source command `spectra-audit`"
---

# source-command-spectra-audit

Use this skill when the user asks to run the migrated source command `spectra-audit`.
