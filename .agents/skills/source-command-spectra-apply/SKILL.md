---
name: "source-command-spectra-apply"
description: "Migrated source command `spectra-apply`"
---

# source-command-spectra-apply

Use this skill when the user asks to run the migrated source command `spectra-apply`.
