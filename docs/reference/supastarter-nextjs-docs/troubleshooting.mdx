...
If this does not work, try also saving the `globals.css` file in the app you are working on and do a hard refresh in the browser.
...
```typescript title="apps/saas/middleware.ts"
