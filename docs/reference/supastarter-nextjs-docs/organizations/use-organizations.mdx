---
title: Use organizations in your application
description: Learn how to use organizations in your supastarter application.
---
...
- `activeOrganizationUserRole`: The current user's membership role in the active organization (`owner`, `admin`, `member`, or `null`)
...
// Prefer Permix checks over role string comparisons
...
See [Permissions and access control](/docs/nextjs/authentication/permissions) for the full permission matrix.
...
To learn more about how to use organizations, please refer to the [better-auth documentation](https://www.better-auth.com/docs/plugins/organization).
