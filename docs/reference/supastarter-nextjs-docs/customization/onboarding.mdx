...
description: Learn how to adjust the onboarding flow in your supastarter app and add a new step.
---
...
Create a new file for your step component in `apps/saas/modules/onboarding/components/`. For example, `OnboardingStep2.tsx` (you could also name it semantically, e.g. `OnboardingStepTeam.tsx`):
...
1. User starts at step 1 (`?step=1`)
2. After completing step 1, they're moved to step 2 (`?step=2`)
3. After completing the final step, they're redirected to the app dashboard
