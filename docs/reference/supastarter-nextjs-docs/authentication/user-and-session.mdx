...
description: Learn how to access the user and session in your supastarter application.
---
...
To use the session on the server, e.g. in a RSC, you can use the `getSession` function from the SaaS auth module.
