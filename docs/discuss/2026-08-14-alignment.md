▋ 已被 mvp-test-scope 取代（部分）

本篇是 2026-08-14 對焦歷史。下列結論已廢，勿當施工單：主金流 SHOPLINE、發票進 v1 程式包、四堂課第 3 堂串 SHOPLINE、第 4 堂發票。

現行：`openspec/specs/`（PAYUNi only、8800、發票不在 MVP、課＋kit、站內 GitHub 領取）。仍有效：獨立 repo、零耦合 libon.me、不抽 Organization、部署常駐 Node、來源不改。
