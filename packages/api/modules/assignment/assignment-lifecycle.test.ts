...
describe("assignment lifecycle cursors", () => {
	it("round-trips an opaque operator pagination cursor", () => {
		const cursor = { id: "submission-1", submittedAt: "2026-08-24T12:00:00.000Z", createdAt: "2026-08-24T11:00:00.000Z" };
	...
	it("rejects malformed or unsafe cursors", () => {
		...
		expect(decodeAssignmentSubmissionCursor(encodeAssignmentSubmissionCursor({ id: "", submittedAt: "bad", createdAt: "bad" }))).toBeNull();
	});
});
