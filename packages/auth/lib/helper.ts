 ...
 * Thin wrapper over `@startkiter/permissions` — prefer `check('organization.manage')` in new code.
 */
 ...
 * Thin wrapper over `@startkiter/permissions` — prefer `check('organization.delete')` in new code
