...
- [x] 6.5 實作 `packages/course/src/course-pack/checks/bunny-zone-created.ts`，使 6.3、6.4 測試轉綠燈並註冊進 check-registry；驗證目標：`pnpm --filter course test bunny-zone-created.test.ts` 全綠
