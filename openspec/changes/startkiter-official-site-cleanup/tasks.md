...
- [ ] 3.1 涵蓋 Requirement「The legacy Vercel deployment is decommissioned」：在 Vercel 後台移除本 repo 的 Git 整合／關閉 auto-deploy webhook；驗證目標：推一個測試 commit 到 main，確認 Vercel 專案沒有觸發新的部署
