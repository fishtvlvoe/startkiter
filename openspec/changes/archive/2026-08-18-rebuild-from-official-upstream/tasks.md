...
- [x] 10.3 用 ego-browser 對首頁、登入頁、後台首頁、課程頁、checkout 頁分別與 `demo.supastarter.dev` 對應頁面並排截圖，確認版面骨架（Logo icon、瀏覽器窗格內容、卡片邊框樣式）與官方一致，驗證方式：截圖存於 `docs/verification/rebuild-from-official-upstream/` 並附比對結論
